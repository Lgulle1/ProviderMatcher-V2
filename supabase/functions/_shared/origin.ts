...
/**
 * An empty domain list means "not configured" and allows everything — same as
 * the widget. Once a list exists it is enforced, and a request with no usable
 * Origin/Referer (curl, server-to-server) is denied: that is precisely the
